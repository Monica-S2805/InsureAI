...
public class AppointmentService {
    ...
    // 🔹 Employee reporting
    public long countByEmployee(String email) {
        return appointmentRepository.countByEmployeeEmail(email);
    }

    public long countByEmployeeAndStatus(String email, String status) {
        return appointmentRepository.countByEmployeeEmailAndStatus(email, status);
    }
    ...
    public long countUpcomingByEmployee(String email) {
